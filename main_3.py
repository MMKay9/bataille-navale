...
class BatailleNavaleApp(tk.Tk):
    def __init__(self):
        ...
        # Indique le joueur courant (utile en phase de jeu si on voulait gérer les tours).
        ...
        # Détails de navires (player / computer) : liste de dicos {name, size, coords, hits, sunk}
    ...
    def player_shoot_computer(self, row, col):
        ...
        - Ensuite l’ordinateur tire à son tour.
        """
        ...
        # Tir de l’ordinateur (simple IA aléatoire) après le tir du joueur
    ...
    def computer_shoot_player(self):
        ...
        if cell_value == 1:
            ...
            if cell_value in [2, 3]:
                # (Théoriquement, ça ne devrait pas arriver vu la vérif ci-dessus.)
                pass
            else:
